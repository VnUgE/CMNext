        ...
        if (isNew.value) {
            ...
            if (hasFile) {
                ...
                const { isCanceled } = await confirm({
                    ...
                    message:
                        'Are you sure you want to overwrite the file? This action cannot be undone.',
                });
                if (isCanceled) {
                    return;
                }
    ...
    <div id="content-editor-page" class="p-6 space-y-6 max-w-7xl mx-auto">
        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div>
                ...
                <p v-if="isNew" class="text-base-content/70 mt-1">
                    Upload new content to this channel
                </p>
