        ...
        <fieldset class="mx-auto flex flex-col gap-6 w-lg">
            ...
            <div class="space-y-4">
                ...
                <div class="form-control">
                    ...
                    <input
                        v-model="buffer.name" type="text" class="input input-bordered w-full"
                ...
                <div class="form-control">
                    ...
                    <input
                        v-model="buffer.path" type="text" class="input input-bordered w-full"
                        placeholder="Enter base directory path" :disabled="!isNew"
                    >
                    <div class="label">
                ...
                <div class="form-control">
                    ...
                    <input
                        v-model="buffer.index" type="text" class="input input-bordered w-full"
                        placeholder="posts.json" :disabled="!isNew"
                    >
                    <div class="label">
                        <span v-if="isNew" class="label-text-alt">
                ...
                <div class="form-control">
                    ...
                    <input
                        v-model="buffer.content" type="text" class="input input-bordered w-full"
                        placeholder="content" :disabled="!isNew"
                    >
                    <div class="label">
                        <span v-if="isNew" class="label-text-alt">
