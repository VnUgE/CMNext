    ...
    <div class="card bg-base-100 shadow-xl border border-base-200">
        ...
        <div class="card-body p-4 space-y-4">
            ...
            <div class="form-control">
                ...
                <select v-model="channelId" class="select select-bordered select-sm w-full" :disabled="!isNew">
            ...
            <div class="form-control">
                ...
                <input
                    :value="postCreatedDate" disabled 
            ...
            <div class="form-control">
                ...
                <input
                    v-model="buffer.author" type="text" placeholder="Author name..."
            ...
            <div class="form-control">
                ...
                <input
                    v-model="buffer.image" type="url" placeholder="https://example.com/image.jpg"
                    class="input input-bordered input-sm w-full"
                >
                <div v-if="buffer.image" class="mt-2">
                    <img
                        :src="buffer.image" alt="Featured image preview"
