...
const sortedPosts = computed(() => {
    ...
    if (search.value) {
        sorted = filter(sorted, post => {
            return includes(toLower(post.title), toLower(search.value)) ||
                ...
                <div class="card-body py-4">
                    <div class="flex gap-4 items-center">
                        <div class="form-control flex-1">
                            <input
                                v-model="search" type="text" class="input input-bordered w-full"
                    ...
                    <div class="card-actions justify-end mt-4">
                        <div class="join">
                            <router-link
                                ...
                                :to="`/channels/${channelId}/posts/${post.id}`" title="Edit Post"
                            >
                                <fa-icon icon="edit" />
                            </router-link>
                            <router-link
                                class="btn btn-sm btn-secondary join-item"
                                :to="`/channels/${channelId}/content`" title="Copy Link"
                            >
                                <fa-icon icon="link" />
                            </router-link>
                            <button
                                class="btn btn-sm btn-error join-item" title="Delete Post"
