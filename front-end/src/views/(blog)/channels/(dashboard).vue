...
import { defer, toLower } from 'lodash-es';
...
const deleteChannel = async (channel: any) => {
    ...
    apiCall(async () => {
        await cmnext.channels.delete(channel.id);

        toaster.success(
            'Channel Deleted',
            `Channel "${channel.name}" has been deleted successfully.`
        );
    });
};
...
<template>
    <div class="p-6 space-y-6 max-w-7xl mx-auto">
        ...
        <div v-else-if="searchFilter.length === 0" class="text-center py-12">
            ...
            <p v-if="searchTerm" class="text-base-content/50 mb-6">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div
                                    ...
                                    :class="true ? 'badge-success' : 'badge-ghost'"
                                >
                                    Active
                                </div>
                            </div>
