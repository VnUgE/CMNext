...
const submitLogin = (method: SocialOAuthMethod) =>
  apiCall(async () => {
...
<template>
  ...
  <div
    v-if="errorMethods.length"
    class="collapse collapse-arrow border border-base-300 rounded-lg mt-4"
  >
    <input type="checkbox" />
