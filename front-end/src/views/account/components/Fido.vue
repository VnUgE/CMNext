      ...
      <table class="table table-sm">
        ...
        <tbody>
          <tr v-for="device in devices" :key="device.id">
            ...
            <td class="hidden sm:table-cell max-w-32 truncate text-base-content/60 text-xs">
              {{ device.id }}
            </td>
            ...
            <td class="text-right">
              <button class="btn btn-xs btn-ghost text-error" @click="onRemoveDevice(device)">
      ...
      <div class="max-w-md">
        <form class="space-y-4" @submit.prevent="onRegisterDevice()">
          ...
          <div class="flex justify-end gap-2">
            <button type="button" class="btn btn-ghost" @click.prevent="toggleOpen(false)">
              Cancel
            </button>
