...
const isMethodSelected = (upgrade: MfaFlow<MfaMethod> | undefined, type: MfaMethod) => upgrade?.type === type;
...
<template>
    <div class="">
                    ...
                    <div v-for="upgrade in mfaUpgrades" :key="upgrade.type" class="flex flex-row gap-4">
                        ...
                        >
                            <span>
                                ...
                                >
                                    <path
                                        stroke-linecap="round" stroke="currentColor" stroke-linejoin="round"
        ...
        <form v-else id="user-pass-submit-form" method="post" action="/login" @submit.prevent="SubmitLogin">
            <fieldset class="mt-10" :disabled="waiting">
                <div class="pt-3">
                    <label class="input input-bordered flex items-center gap-2 w-full">
                        ...
                        <input
                            v-if="loginData.enforce_email" id="username" v-model="vState.username" tabindex="1"
                            type="email" autocomplete="username" class="grow" placeholder="Email"
                        >

                        <input
                            v-else id="username" v-model="vState.username" tabindex="1" type="text"
                ...
                <div class="py-5">
                    <label class="input input-bordered flex items-center gap-2 w-full">
                        ...
                        <input
                            id="password" v-model="vState.password" tabindex="2" type="password"
            ...
            <button
                tabindex="3" type="submit" form="user-pass-submit-form" class="btn btn-primary w-full"
                :disabled="waiting"
            >
